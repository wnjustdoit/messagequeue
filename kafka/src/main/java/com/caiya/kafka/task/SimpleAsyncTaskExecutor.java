...
import com.caiya.kafka.util.ConcurrencyThrottleSupport;
import com.caiya.kafka.util.CustomizableThreadCreator;
import com.caiya.kafka.util.concurrent.ListenableFuture;
import com.caiya.kafka.util.concurrent.ListenableFutureTask;

/**
 * {@link Executor} implementation that fires up a new Thread for each task,
